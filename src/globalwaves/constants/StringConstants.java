...
public final class StringConstants {
    ...
    public static final String LOAD_NO_SELECT =  "Please select a source before attempting to load.";
    ...
    public static final String SHUFFLE_NOT_COLLECTION = "The loaded source is not a playlist or an album.";
